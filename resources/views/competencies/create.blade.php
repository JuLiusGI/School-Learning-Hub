        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('competencies.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="matatag_tag" name="matatag_tag" type="text" class="mt-1 block w-full" value="{{ old('matatag_tag') }}" required />
